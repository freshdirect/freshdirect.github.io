...
<div class="usa-accordion-bordered usa-accordion-docs">
  ...
  <div id="collapsible-0" aria-hidden="false" class="usa-accordion-content">
    ...
    <ul class="usa-content-list">
      <li>All overlays should have <em class="em-yellow-bg"><code>role=”dialog”</code></em> attribute.</li>
      <li>Make overlay copy accessible by using <em class="em-yellow-bg"><code>aria-labelledby=""</code></em> for headers, and <em class="em-yellow-bg"><code>aria-describedby=""</code></em> for paragraphs. This way screen readers will know to relay this information to the customer. <div><a href="https://www.w3.org/WAI/GL/wiki/Using_ARIA_role%3Ddialog_to_implement_a_modal_dialog_box">See code examples and resources</a></div> </li>
...
<p class="usa-font-lead">Carousels are used to display both transactional and informational content.</p>
...
<!--   <h3>Informational Carousel</h3>
  ...
  <ul class="usa-content-list c-features">
    ...
    <li>
      ...
      <p>Copy text format includes product list name and number of items. <i>Example: View All [Product List Name] [Number of Items]</i></p>
